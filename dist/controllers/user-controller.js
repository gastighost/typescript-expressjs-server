...
exports.createUser = (0, async_wrapper_1.default)(async (req, res, next) => {
    ...
    const newUser = await user_services_1.default.createAUser({
        username,
        email,
        password,
    });
...
exports.getUser = (0, async_wrapper_1.default)(async (req, res, _next) => {
    ...
    const user = await user_services_1.default.getAUser(userId);
...
exports.editUser = (0, async_wrapper_1.default)(async (req, res, next) => {
    ...
    const { userId } = req.params;
    const { username, email, password } = req.body;
    const user = await user_services_1.default.editAUser(userId, {
        username,
        email,
        password,
    });
...
exports.deleteUser = (0, async_wrapper_1.default)(async (req, res, _next) => {
    const { userId } = req.params;
    const user = await user_services_1.default.deleteAUser(userId);
...
exports.login = (0, async_wrapper_1.default)(async (req, res, next) => {
    ...
    const token = await user_services_1.default.loginUser({ username, password });
